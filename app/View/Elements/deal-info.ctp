...
<?php //print_r($deal); ?>
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="main-box deal-detail" style="background: #fff !important">
            ...
            <span><strong><?php echo __('Job Link'); ?>: </strong><?php echo '<a style="color: #337ab7;" href="' . $deal['Deal']['link'] . '">' . $deal['Deal']['link'] . '</a>' ; ?></span>
...
<div class="row">
    <!-- Description -->
    <div class="col-md-12">
        <div class="main-box deal-details" style="background: #fff !important">
