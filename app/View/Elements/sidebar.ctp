...
<div id="nav-col">
    ...
    <section class="col-left-nano" id="col-left">
        ...
        <div class="col-left-nano-content" id="col-left-inner">
            <div id="sidebar-nav" class="collapse navbar-collapse navbar-ex1-collapse" style="color:##ff7657;">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <?php if ($this->Common->isAdmin()) { ?>
                        ...
                        <li class="<?= ($action == 'deals' && ($this->params['action'] != 'view')) ? 'active' : 'nav-noactive' ?>">
                            ...
                            <a class="dropdown-toggle" href="#"><i class="fa fa-rocket"></i><span><?php echo __('Jeals'); ?></span><i class="fa fa-angle-right drop-icon"></i></a> <ul class="submenu">
                                <li><a class="<?= ($action == 'deals' && ($this->params['action'] == 'index')) ? 'active' : 'nav-noactive' ?>" href="<?php echo $this->Html->url(array('controller' => 'jobs', 'action' => 'index')); ?>"><i class='fa fa-list'></i> <span><?php echo __('List Jobs'); ?></span></a></li>
                                <li><a class="<?= ($action == 'jobs' && ($this->params['action'] == 'favorite')) ? 'active' : 'nav-noactive' ?>" href="<?php echo $this->Html->url(array('controller' => 'jobs', 'action' => 'favorite')); ?>"><i class='fa fa-thumbs-up'></i> <span><?php echo __('Favorite Jobs'); ?></span></a></li>
                                <li><a class="<?= ($action == 'jobs' && ($this->params['action'] == 'archive')) ? 'active' : 'nav-noactive' ?>" href="<?php echo $this->Html->url(array('controller' => 'jobs', 'action' => 'archive')); ?>"><i class='fa fa-thumbs-down'></i> <span><?php echo __('Archived Jobs'); ?></span></a></li>
                            </ul>
                        </li>
                    ...
                    <?php } elseif ($this->Common->isStaff()) { ?>
                        ...
                        <li class="<?= ($action == 'deals' && ($this->params['action'] != 'view')) ? 'active' : '' ?>">
                            <a class="dropdown-toggle" href="#"><i class="fa fa-rocket"></i><span><?php echo __('Jobs'); ?></span><i class="fa fa-angle-right drop-icon"></i></a>
                            <ul class="submenu">
                                <li><a class="<?= ($action == 'deals' && ($this->params['action'] == 'index')) ? 'active' : 'nav-noactive' ?>" href="<?php echo $this->Html->url(array('controller' => 'jobs', 'action' => 'index')); ?>"><i class='fa fa-list'></i> <span><?php echo __('List Jobs'); ?></span></a></li>
                                <li><a class="<?= ($action == 'jobs' && ($this->params['action'] == 'favorite')) ? 'active' : 'nav-noactive' ?>" href="<?php echo $this->Html->url(array('controller' => 'jobs', 'action' => 'favorite')); ?>"><i class='fa fa-thumbs-up'></i> <span><?php echo __('Favorite Jobs'); ?></span></a></li>
                                <li><a class="<?= ($action == 'jobs' && ($this->params['action'] == 'archive')) ? 'active' : 'nav-noactive' ?>" href="<?php echo $this->Html->url(array('controller' => 'jobs', 'action' => 'archive')); ?>"><i class='fa fa-thumbs-down'></i> <span><?php echo __('Archived Jobs'); ?></span></a></li>
                        ...
                        <!-- if client -->
                    <?php } else { ?>
                        <li class="<?= ($action == 'deals') ? 'active' : 'nav-noactive' ?>"><a href="<?php echo $this->Html->url(array('controller' => 'jobs', 'action' => 'client')); ?>"><i class='fa fa-rocket'></i><span><?php echo __('Deals'); ?></span></a> </li>
                        <li class="<?= ($action == 'invoices') ? 'active' : 'nav-noactive' ?>"><a href="<?php echo $this->Html->url(array('controller' => 'invoices', 'action' => 'index')); ?>"><i class='fa fa-file-text-o'></i><span><?php echo __('Invoices'); ?></span></a> </li>
                        <li class="<?= ($action == 'messages') ? 'active' : 'nav-noactive' ?>"><a href="<?php echo $this->Html->url(array('controller' => 'messages', 'action' => 'index')); ?>"><i class='fa fa-envelope'></i><span><?php echo __('Messages'); ?></span></a></li>
                        <li class="<?= ($action == 'tickets') ? 'active' : 'nav-noactive' ?>"><a href="<?php echo $this->Html->url(array('controller' => 'tickets', 'action' => 'index')); ?>"><i class='fa fa-ticket'></i><span><?php echo __('Tickets'); ?></span></a></li>                   
                    <?php } ?>
