    ...
    <div class="col-lg-12">
        <div class="row">
            <div class="col-lg-12">
                <div class="clearfix">                                                                
                    <div class="col-sm-6">
                        <h1><?php echo __('Jobs List'); ?></h1>
                    </div>   
                    <?php if ($this->Common->isAdminStaff()): ?>
                        <div class="col-sm-2 form-group">
                            <?php echo $this->Form->input('deal_id', array('type' => 'text', 'class' => 'form-control search-data', 'placeholder' => __('Quick Search Jobs'), 'data-name' => 'deals', 'label' => false, 'div' => false)); ?> 
                        </div>
                        ...
                        <div class="col-sm-2 col-xs-6 form-group"> 
                            <a class="btn btn-primary pull-right" href="#" data-toggle="modal" data-target="#dealM">
                                <i class="fa fa-plus-circle fa-lg"></i> <?php echo __('Add Job'); ?>
                            </a>                         
                        </div> 
                    <?php endif; ?>
                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="main-box no-header clearfix">					  
				    ...
				    <?php /* <div class="col-lg-4 form-group">                                                      
				     ...
				     */ ?>
						...
						*/ ?>
                                        ...
                                        if (!empty($deals)) :
                                            ...
                                            foreach ($deals as $row) :
                                                ...
                                                <tr  id="<?php echo 'row' . h($row['Deal']['id']); ?>">
                                                    <td> <a  href="<?php echo $this->Html->url(array("controller" => "jobs", "action" => "view", h($row['Deal']['id']))); ?>" ref="popover" data-content="View Deal"><?= h($row['Deal']['name']); ?></a></td>
						     ...
						     */ ?>
                                                    ...
                                                    <td>	                              
                                                        <a class="table-link danger" href="#" ref="popover" data-content="Delete Job" data-toggle="modal" data-target="#delDealM" onclick="fieldU('DealId',<?php echo h($row['Deal']['id']); ?>)">
