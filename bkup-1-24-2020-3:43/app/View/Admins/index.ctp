                                    ...
                                    <ul id="<?= h($stage['Stage']['id']); ?>" class="droppable sortable stage-ul"> 
                                        ...
                                        <?php foreach ($stage['Deal'] as $row): ?>
                                            ...
                                            <li class="ui-state-default" id="<?= h($row['Deal']['id']); ?>">
                                                ...
                                                <div class="deal-name">
                                                    <i class="fa fa-eye"></i> <?php echo $this->Html->link(h($row['Deal']['name']), array('controller' => 'deals', 'action' => 'view', h($row['Deal']['id'])), array('escape' => false, 'ref' => 'popover', 'data-content' => 'View Job')); ?>
