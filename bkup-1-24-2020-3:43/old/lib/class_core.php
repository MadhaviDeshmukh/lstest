  ...
  class Core
  {
	  ...
	  if (empty(Filter::$msgs)) {
			  $data = array(
					  ...
					  'offline_d' => isset($_POST['offline_d_submit']) && $_POST['offline_d_submit'] != '' ? sanitize($_POST['offline_d_submit']) : '1970-01-01',
					  'offline_t' => isset($_POST['offline_t_submit'])  && $_POST['offline_t_submit'] != '' ? sanitize($_POST['offline_t_submit']) : '00:00:01',
