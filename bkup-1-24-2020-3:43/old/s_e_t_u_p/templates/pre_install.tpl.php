...
<p>These settings are recommended for PHP in order to ensure full compatibility with Job Board.
  However, Job Board will still operate if your settings do not quite match the recommended.</p>
<table class="inner-content">
  <thead>
    <tr>
      <th>Extension</th>
...
<p>In order for Job Board to function correctly it needs to be able to access or write to certain files or directories. If you see "Unwriteable" you need to change the permissions on the file or directory to allow Job Board to write to it.</p>
<table class="inner-content">
