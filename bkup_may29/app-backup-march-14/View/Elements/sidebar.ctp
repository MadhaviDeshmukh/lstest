                    ...
                    <?php if ($this->Common->isAdmin()) { ?>
                        ...
                        <li class="<?= ($action == 'deals' && ($this->params['action'] != 'view')) ? 'active' : 'nav-noactive' ?>">
                            ...
                            <a class="dropdown-toggle" href="#"><i class="fa fa-rocket"></i><span><?php echo __('Jeals'); ?></span><i class="fa fa-angle-right drop-icon"></i></a> <ul class="submenu">
                                <li><a class="<?= ($action == 'deals' && ($this->params['action'] == 'index')) ? 'active' : 'nav-noactive' ?>" href="<?php echo $this->Html->url(array('controller' => 'deals', 'action' => 'index')); ?>"><i class='fa fa-list'></i> <span><?php echo __('List Jobs'); ?></span></a></li>
                                <li><a class="<?= ($action == 'deals' && ($this->params['action'] == 'won')) ? 'active' : 'nav-noactive' ?>" href="<?php echo $this->Html->url(array('controller' => 'deals', 'action' => 'won')); ?>"><i class='fa fa-thumbs-up'></i> <span><?php echo __('Favorite Jobs'); ?></span></a></li>
                                <li><a class="<?= ($action == 'deals' && ($this->params['action'] == 'loss')) ? 'active' : 'nav-noactive' ?>" href="<?php echo $this->Html->url(array('controller' => 'deals', 'action' => 'loss')); ?>"><i class='fa fa-thumbs-down'></i> <span><?php echo __('Archived Jobs'); ?></span></a></li>
                            </ul>
                        </li>
