...
class AppController extends Controller
{
    ...
    public function beforeFilter()
    {
        ...
        $this->Auth->allow('login', 'logingoogle', 'forgotPassword', 'landingPage', 'termsPage', 'aboutPage','privacyPage','cookiesPage','contactusPage');
    ...
    public function checkLogin()
    {
        if (!$this->Auth->user('id') || $this->Auth->user('active') == '0') {
            ...
            return $this->redirect(array('controller' => 'landing', 'action' => 'landingPage'));
        }
    }
