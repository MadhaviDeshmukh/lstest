...
class ContactsController extends AppController
{
    ...
    public function index($letter = null)
    {
        ...
        if ($letter) {
            ...
            if (!$this->checkAdmin()) {
	        $conditions['Contact.user_id ='] = $uid;
            }
        } else {
            //$conditions = null;
            if (!$this->checkAdmin()) {
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $this->request->data['Contact']['location'] = '';
            $this->request->data['Contact']['skype'] = '';
            //if contact saved
    ...
    public function search()
    {
        ...
        if ($this->RequestHandler->isAjax()) {
	        ...
	        $conditions['Contact.user_id ='] = $uid;
                $results = $this->Contact->find('all', array('conditions' => array('Contact.user_id =' =>  $userId, 'Contact.name LIKE' => '%' . $name . '%'), 'fields' => array('Contact.name,Contact.id')));
            }
