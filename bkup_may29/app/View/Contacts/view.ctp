            ...
            <div class="main-box no-header clearfix">	
                <div class="main-box-body clearfix">
                    ...
                    <div class="row">                     
                                    ...
                                    <?php if ($this->Common->isStaffPermission('13')): ?>
                                        <div>
                                            <span class="btn default btn-file">
                                                <span class="fileinput-new"><?php echo __('Change image'); ?></span>
                                                <span class="fileinput-exists"><?php echo __('Select another'); ?></span>
					    ...
					    <a href="#" class="btn default fileinput-exists" id="PicSubmitBtn" onclick="$(this).closest('form').submit();">Save</a>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                <?php echo $this->Form->end(); ?>
                        ...
                        <div class="col-lg-5">
                            <dl class="dl-horizontal">
                                <dt><?php echo __('Title'); ?>:</dt> <dd><span class=""><?= h($contact['Contact']['title']); ?></span></dd>
                        ...
                        <div id="cluster_info" class="col-lg-5">
                            <dl class="dl-horizontal">
                                <dt><?php echo __('Website'); ?>:</dt> <dd> <?= h($contact['Contact']['website']); ?> </dd>
                                <dt><?php echo __('LinkedIn'); ?>:</dt> <dd> <?= h($contact['Contact']['linkedIn']); ?> </dd>
                                <dt><?php echo __('FaceBook'); ?>:</dt> <dd> <?= h($contact['Contact']['facebook']); ?> </dd>
                                <dt><?php echo __('Twitter'); ?>:</dt> <dd> <?= h($contact['Contact']['twitter']); ?> </dd>
                                <!-- Custom Fields -->
                                <?php foreach ($custom as $row): ?>
                            ...
                            <div class="panel blank-panel">
                                <div class="panel-heading">
                                    <div class="panel-options">
                                        <ul class="nav nav-tabs">
                                            <li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="true"><?php echo __('Jobs'); ?></a></li>
                                            <li class=""><a data-toggle="tab" href="#tab-2" aria-expanded="true"><?php echo __('More details'); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <table class="table table-striped user-list">
                                                ...
                                                <tbody>
                                                    <?php foreach ($deals as $row) : ?>
                                                        <tr>
                                                            <td><a href="<?php echo $this->Html->url(array('controller' => 'jobs', 'action' => 'view', h($row['Deal']['id']))); ?>">  <?= h($row['Deal']['name']); ?></a></td>
