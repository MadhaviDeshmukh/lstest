                ...
                <div class="clearfix">
                    <?php if ($this->Common->isAdmin() || $this->Common->isStaff()) { ?>
                        <div class="col-lg-8 col-sm-12 col-xs-24">
                            <h1 class="pull-left job-title"> <?= h($deal['Deal']['name']); ?></h1>
                        </div>
			    <div class="col-lg-4 col-sm-6 col-xs-12 job-view-colum">
                            <?php /* foreach ($labels as $row): ?>
                                <span class="label label-default job-view-label <?= h($row['Label']['color']); ?>"><?= h($row['Label']['name']); ?></span>
			    <?php endforeach; */ ?>
                            </div>                                           
                        <div class="col-lg-4 col-sm-6 col-xs-12 job-view-colum">
                            <div class="job-right text-right">
