    ...
    <div class="cd-timeline-block">        
        ...
        switch ($row['Timeline']['module']) {
            case "add_Deal":
                ...
                echo '<p>' . __('<span class="label label-success">JOB CREATED</span>') . ' </p> </div>';
                break;
            case "add_Contact":
            ...
            case "add_File":
                ...
                echo '<div class="cd-timeline-content"><b>' . h($row['Timeline']['user']) . '</b>';
                echo '<span class="pull-right"><i class="fa fa-clock-o"></i> ' . $this->Time->format($this->Common->dateTime(), h($row['Timeline']['created'])) . '</span>';
                echo '<p>' . __('<span class="label label-success">FILE ADDED</span>') . ' <b>' . h($row['Timeline']['activity']) . '</b></p> </div>';
                break;
            case "unlink_File":
                echo '<div class="cd-timeline-img cd-del"><i class="fa fa-file-pdf-o fa-2x"></i></div>';
                echo '<div class="cd-timeline-content"><b>' . h($row['Timeline']['user']) . '</b>';
                echo '<span class="pull-right"><i class="fa fa-clock-o"></i> ' . $this->Time->format($this->Common->dateTime(), h($row['Timeline']['created'])) . '</span>';
                echo '<p>' . __('<span class="label label-danger">FILE DELETED</span>') . ' <b>' . h($row['Timeline']['activity']) . '</b></p> </div>';
                break;
            case "add_Discussion":
            ...
            case "add_Task":
                ...
                echo '<div class="cd-timeline-content"><b>' . h($row['Timeline']['user']) . '</b>';
                echo '<span class="pull-right"><i class="fa fa-clock-o"></i> ' . $this->Time->format($this->Common->dateTime(), h($row['Timeline']['created'])) . '</span>';
                echo '<p>' . __('<span class="label label-default">TASK CREATED</span>') . ' <b>' . h($row['Timeline']['activity']) . '</b></p> </div>';
                break;
            case "update_Task":
                echo '<div class="cd-timeline-img cd-edit"><i class="fa fa-tasks fa-2x"></i></div>';
                echo '<div class="cd-timeline-content"><b>' . h($row['Timeline']['user']) . '</b>';
                echo '<span class="pull-right"><i class="fa fa-clock-o"></i> ' . $this->Time->format($this->Common->dateTime(), h($row['Timeline']['created'])) . '</span>';
                echo '<p>' . __('<span class="label label-default">TASK UPDATED</span>') . ' <b>' . h($row['Timeline']['activity']) . '</b></p> </div>';
                break;
            case "unlink_Task":
                echo '<div class="cd-timeline-img cd-del"><i class="fa fa-tasks fa-2x"></i></div>';
                echo '<div class="cd-timeline-content"><b>' . h($row['Timeline']['user']) . '</b>';
                echo '<span class="pull-right"><i class="fa fa-clock-o"></i> ' . $this->Time->format($this->Common->dateTime(), h($row['Timeline']['created'])) . '</span>';
                echo '<p>' . __('<span class="label label-danger">TASK DELETED</span>') . ' <b>' . h($row['Timeline']['activity']) . '</b></p> </div>';
                break;
            case "add_User":
            ...
            case "move_Stage":
                ...
                echo '<div class="cd-timeline-content"><b>' . h($row['Timeline']['user']) . '</b>';
                echo '<span class="pull-right"><i class="fa fa-clock-o"></i> ' . $this->Time->format($this->Common->dateTime(), h($row['Timeline']['created'])) . '</span>';
                echo '<p>' . __('<span class="label label-info">STAGE UPDATED</span>') . ' <b>' . h($row['Timeline']['activity']) . '</b></p></div>';
                break;
            case "won_Deal":
                echo '<div class="cd-timeline-img"><i class="fa fa-thumbs-up fa-2x"></i></div>';
                echo '<div class="cd-timeline-content"><b>' . h($row['Timeline']['user']) . '</b>';
                echo '<span class="pull-right"><i class="fa fa-clock-o"></i> ' . $this->Time->format($this->Common->dateTime(), h($row['Timeline']['created'])) . '</span>';
                //echo '<p>' . __('<span class="label label-success">Favorited</span> the job') . ' <b>' . h($row['Timeline']['activity']) . '</b></p></div>';
                echo '<p>' . __('<span class="label label-success">STARRED</span>') . '</p></div>';
                break;
            case "loss_Deal":
                ...
                echo '<p>' . __('<span class="label label-warning">ARCHIVED</span>') . '</p></div>';
                break;
            case "make_active":
                echo '<div class="cd-timeline-img"><i class="fa fa-arrow-up fa-2x"></i></div>';
                echo '<div class="cd-timeline-content"><b>' . h($row['Timeline']['user']) . '</b>';
                echo '<span class="pull-right"><i class="fa fa-clock-o"></i> ' . $this->Time->format($this->Common->dateTime(), h($row['Timeline']['created'])) . '</span>';
                echo '<p>' . __('<span class="label label-success">ACTIVATED</span>') . '</p></div>';
                break;
            default:
                echo '';
                break;
