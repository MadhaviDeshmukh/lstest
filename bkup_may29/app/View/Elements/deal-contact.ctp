<?php
/**
 *  List contacts in job details page.
 * 
 */
...
<div class="row">
    <div class="input-group col-md-12">
        <?php echo $this->Form->input('Contact.name', array('type' => 'text', 'class' => 'form-control input-lg typeahead', 'data-provide' => 'typeahead', 'label' => false, 'div' => false, 'Placeholder' => __('Search Contacts'), 'id' => 'contacts', 'label' => '', 'autocomplete' => 'on')); ?>
    </div>
</div>
