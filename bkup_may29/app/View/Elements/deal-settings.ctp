<?php
/**
 * job view setting tab for clients
 * 
 * @author:   AnkkSoft.com
    ...
    <div class="panel-body">
        ...
        <div class="checkbox-nice">
            ...
            <label for="checkbox-1">
                <?php echo __('Allow client to view job tasks'); ?>
            </label>
        </div>
        <hr>
        <div class="checkbox-nice">
            ...
            <label for="checkbox-2">
                <?php echo __('Allow client to view job products'); ?>
            </label>
        </div>
        <hr>
        <div class="checkbox-nice">
            ...
            <label for="checkbox-3">
                <?php echo __('Allow client to view job sources'); ?>
            </label>
        </div>
        <hr>
        <div class="checkbox-nice">
            ...
            <label for="checkbox-4">
                <?php echo __('Allow client to view job contacts'); ?>
            </label>
        </div>
        <hr>
        <div class="checkbox-nice">
            ...
            <label for="checkbox-5">
                <?php echo __('Allow client to view job files'); ?>
            </label>
        </div>
        <hr>
        <div class="checkbox-nice">
            ...
            <label for="checkbox-6">
                <?php echo __('Allow client to view job discussion'); ?>
            </label>
        </div>
        <hr>
        <div class="checkbox-nice">
            ...
            <label for="checkbox-7">
                <?php echo __('Allow client to view job invoices'); ?>
            </label>
        </div>
        <hr>
        <div class="checkbox-nice">
            ...
            <label for="checkbox-8">
                <?php echo __('Allow client to view job custom fields'); ?>
            </label>
        </div>
        <hr>
        <div class="checkbox-nice">
            ...
            <label for="checkbox-9">
                <?php echo __('Allow client to view job members'); ?>
            </label>
        </div>
        <hr>     
        <div class="checkbox-nice">
            ...
            <label for="checkbox-10">
                <?php echo __('Allow client to add files in job'); ?>
            </label>
        </div>
        <hr> 
        <div class="checkbox-nice">
            ...
            <label for="checkbox-11">
                <?php echo __('Allow client to job activity'); ?>
            </label>
        </div>
