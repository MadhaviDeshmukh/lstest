                 ...
                 <!--<li class="dropdown language-dropdown">
                    ...
                    <li class="dropdown profile-dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <li><a href="<?php echo $this->Html->url(array('controller' => 'users', 'action' => 'logout')); ?>" onclick="return googleSignOut();"><i class='fa fa-power-off'></i><span><?php echo __('Logout'); ?></span></a></li>
                            <!--<li><a href="#" onclick="return googleSignOut();"><i class='fa fa-power-off'></i><span><?php echo __('Logout'); ?></span></a></li>-->
                        </ul>
                    </li>
                </ul>
            </div>
