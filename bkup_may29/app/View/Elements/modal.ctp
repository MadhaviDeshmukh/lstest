...
<?php if (!empty($box)) : ?>
    ...
    <ul class="nav nav-tabs">
        <!--<li class="active"><a data-toggle="tab" href="#tab-deal"><?php echo __('Job Details'); ?></a></li> -->
	...
	<div id="tab-deal" class="tab-pane fade active in">
		...
		<?php echo $this->Form->input('Deal.xyz', array('type' => 'text', 'class' => 'form-control input-inline input-medium', 'Placeholder' => __('Job Link'), 'label' => false, 'div' => false)); ?>	
<form action="" method="post" id="url-setter">
    <input type="text" name="url" id="url" />
    <button type="submit" name="submit" onClick='loadIframeURL();'>Change URL</button>
</form>
...
function loadIframeURL() {
	alert("Called");
        "use strict";
        var url_setter = document.getElementById('url-setter'), url = document.getElementById('DealXyz'), the_iframe = document.getElementById('the-frame');
        ...
        /*url_setter.onsubmit = function (event) {
          ...
          <div class="col-sm-6 form-group">
            <div class="form-group">
                <label><?php echo __('Job Link'); ?></label>
                <?php echo $this->Form->input('Deal.link', array('type' => 'text', 'class' => 'form-control input-inline input-medium', 'Placeholder' => __('Job Link'), 'label' => false, 'div' => false)); ?>	
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <?php echo $this->Form->input('Deal.company_id', array('type' => 'select', 'class' => 'select-tags full-width', 'options' => array($companies), 'empty' => __('Select Company'), 'label' => false, 'div' => false)); ?>	
            </div>
            <!--<div class="form-group">
