    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo __('Edit Job'); ?></h4>
            </div>
            <?php echo $this->Form->create('Deal', array('url' => array('controller' => 'Jobs', 'action' => 'edit'), 'inputDefaults' => array('label' => false, 'div' => false), 'class' => 'vForm')); ?>
            <?php echo $this->Form->input('Deal.id', array('type' => 'hidden', 'value' => h($deal['Deal']['id']))); ?>
            <div class="modal-body tab-modal">
                <div class="form-group">
                    <label><?php echo __('Name'); ?></label>
                    <?php echo $this->Form->input('Deal.name', array('type' => 'text', 'class' => 'form-control input-inline input-medium', 'Placeholder' => __('Job Name'), 'value' => h($deal['Deal']['name']))); ?>	
                </div>
                <div class="form-group">
                    <label><?php echo __('Price'); ?></label>
                    <div class="input-group">
                        <span class="input-group-addon"> <?= $this->Session->read('Auth.User.currency_symbol'); ?></span>
                        <?php echo $this->Form->input('Deal.price', array('type' => 'text', 'class' => 'form-control input-inline input-medium', 'Placeholder' => __('Job Price'), 'value' => h($deal['Deal']['price']))); ?>
                    </div>
                </div> 
            </div>        
...
<div class="modal fade" id="wonM">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo $this->Form->input('id', array('type' => 'hidden', 'value' => h($deal['Deal']['id']))); ?>
            <div class="modal-body">						
                <p><strong> <?php echo __('Reason for favoriting?'); ?></strong></p>
                <div class="form-group">
                    <label></label>
                    <?php echo $this->Form->input('History.reason', array('type' => 'textarea', 'class' => 'form-control input-inline input-medium', 'Placeholder' => __('Reason?'), 'div' => false, 'label' => false, 'rows' => '4')); ?>	
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn btn-primary blue btn-sm" type="submit"><i class="fa fa-check"></i> <?php echo __('Favorite'); ?></button>
...
<div class="modal fade" id="pipelineM">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo $this->Form->create('Deal', array('url' => array('controller' => 'Jobs', 'action' => 'update_pipeline'), 'inputDefaults' => array('label' => false, 'div' => false), 'class' => 'form-horizontal')); ?>
            <?php echo $this->Form->input('id', array('type' => 'hidden', 'value' => h($deal['Deal']['id']))); ?>
            <div class="modal-body">		
                <div class="form-group">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 deal-view-colum">
                            <div class="deal-right text-right">
                                ...
                                <!--<a class="btn btn-primary" href="#" data-toggle="modal" data-target="#editM">
                                    <i class="fa fa-pencil"></i> <?php echo __('Edit Job'); ?>
                                </a>-->
                                <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#wonM">
                                    <i class="fa fa-star"></i>
                                </a>&nbsp;
                                <a class="btn btn-primary" href="#" data-toggle="modal" data-target="#lossM">
                                    <i class="fa fa-archive"></i>
                                </a>&nbsp;
                                <a class="btn btn-danger" href="#" data-toggle="modal" data-target="#dealDM" data-action="deals">
                ...
                <div class="main-box clearfix" style="background: #fff">	
                    <div class="tabs-wrapper tabs-no-header">
                        ...
                        <ul class="nav nav-tabs deal-tab">
                            <li class="active"><a data-toggle="tab" href="#tab-general"><?php echo __('Job Details'); ?></a></li>                            
                            <?php if ($this->Common->isAdmin() || $this->Common->isStaff()): ?>
                                                ...
                                                if (!empty($files)) :
                                                    foreach ($files as $row) :
                                                        ...
                                                        <tr  id="<?php echo 'row' . h($row['AppFile']['id']); ?>">
                                                            <td> <?= h(ltrim(strstr($row['AppFile']['name'], '-'), "-")); ?> </td>
                                                            <td>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="input-group col-md-12">
                                            <h4 class="pull-left"><?php echo __('Notes'); ?></h4>
