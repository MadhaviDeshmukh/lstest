    ...
    <div class="row profile-top">
                ...
                <div>
                    <div>
                        ...
                        <ul class="profile-social"> 
                            <?php if (!empty($user['UserDetail']['skype'])) : ?>  <li><a href="<?php echo h($user['UserDetail']['skype']); ?>" target="_blank"><i class="fa fa-skype fa-2x"></i>  </li><?php endif; ?>       
        ...
        <div class="col-md-2">
            <table class="table small m-b-xs">
                <tbody>
                    <tr>
                        <td><strong><?php echo $deals - ($wonDeals + $lossDeals); ?></strong> <?php echo __('Active Jobs'); ?></td>
                    </tr>
                    <tr>
                        <td> <strong><?php echo $wonDeals; ?></strong> <?php echo __('Favourited'); ?> </td>
                    </tr>
                    <tr>
                        <td><strong><?php echo $lossDeals; ?></strong> <?php echo __('Archived'); ?> </td>
        ...
        <div class="col-md-2">
            <table class="table small m-b-xs">
                <tbody>
                    <tr>
			<td>
                	   <i class="fa fa-envelope"></i> <?php echo h($user['User']['email']); ?>
			</td>
                    </tr>
                    <tr>
			<td>
                <i class="fa fa-phone"></i> <?php echo h($user['UserDetail']['cellphone']); ?>
			</td>
                    </tr>
                    <tr>
			<td>
                <i class="fa fa-home"></i> <?php echo h($user['UserDetail']['location']); ?>
			</td>
                    </tr>
    ...
    <div class="row">
        <div class="col-lg-7">
            <div class="main-box clearfix">
				...
				<?php echo $this->Form->input('UserDetail.google_plus', array('type' => 'text', 'class' => 'form-control', 'placeholder' => 'https://plus.google.com/')); ?>
			     </div>                                
                            <div class="form-group">
