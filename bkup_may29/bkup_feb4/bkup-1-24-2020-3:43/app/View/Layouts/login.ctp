...
<html lang="en">
    <head>
        ...
        ?>
        <div id = "footer-md">
        You've spent months searching for jobs and preparing for interviews. We help you with the <i> last step, </i> starting with a useful tool to track your applications.
        </div>
        </body>
        </head>
