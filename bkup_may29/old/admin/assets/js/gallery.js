(function ($, doc, win) {
    ...
    WojoGrid.prototype.init = function () {
    ...
    WojoGrid.prototype.getColumnsCount = function () {
    ...
    WojoGrid.prototype.onNewContentLoaded = function () {
        this.$el.elasticColumns('refresh');
        this.displayItems();
    };

    WojoGrid.prototype.displayItems = function () {
        var delay = 0;
    ...
    $.fn.WojoGrid = function (opts) {
        return this.each(function () {
            new WojoGrid(this, opts);
        });
    };
    WojoGrid.prototype.onDeleteImage = function () {
        $('body').on('click', 'a.wojo.label', $.proxy(function (e) {
    ...
    WojoGrid.prototype.fileUpload = function () {
        var ul = $('#upload ul');
